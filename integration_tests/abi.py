...
ANCHORING = Contract.from_abi(
    [
        "function appendLeaf(bytes32 commitment, bytes metadata)",
        "function appendLeaves((bytes32 root, uint8 height)[] chunks, bytes metadata)",
        ...
        "event LeafAppended(address indexed namespace, uint256 indexed index, bytes32 commitment,"
        " bytes32[] peaks, bytes metadata)",
        "event LeavesAppended(address indexed namespace, uint256 indexed firstLeaf, uint256 count,"
        " (bytes32 root, uint8 height)[] chunks, bytes32[] peaks, bytes metadata)",
    ]
)
